...
bool pal_vr_read(uint8_t sensor_num, int *reading) {
  ...
  if ( (sensor_num == SENSOR_NUM_PWR_PVCCD_HV) || (sensor_num == SENSOR_NUM_TEMP_PVCCD_HV) || (sensor_num == SENSOR_NUM_CUR_PVCCD_HV)
	|| (sensor_num == SENSOR_NUM_VOL_PVCCD_HV) || (sensor_num == SENSOR_NUM_PWR_PVCCINFAON) || (sensor_num == SENSOR_NUM_TEMP_PVCCINFAON)
	|| (sensor_num == SENSOR_NUM_CUR_PVCCINFAON) || (sensor_num == SENSOR_NUM_VOL_PVCCINFAON) || (sensor_num == SENSOR_NUM_PWR_PVCCIN)
	|| (sensor_num == SENSOR_NUM_TEMP_PVCCIN) || (sensor_num == SENSOR_NUM_CUR_PVCCIN) || (sensor_num == SENSOR_NUM_VOL_PVCCIN)) {
    msg.data[0] = 0x00;
    msg.data[1] = 0x00;    //switch to page 0
  } else if ( (sensor_num == SENSOR_NUM_PWR_PVCCFA_EHV) || (sensor_num == SENSOR_NUM_TEMP_PVCCFA_EHV) || (sensor_num == SENSOR_NUM_CUR_PVCCFA_EHV) 
	|| (sensor_num == SENSOR_NUM_VOL_PVCCFA_EHV) || (sensor_num == SENSOR_NUM_PWR_PVCCFA_EHV_FIVRA) || (sensor_num == SENSOR_NUM_TEMP_PVCCFA_EHV_FIVRA)
	|| (sensor_num == SENSOR_NUM_CUR_PVCCFA_EHV_FIVRA) || (sensor_num == SENSOR_NUM_VOL_PVCCFA_EHV_FIVRA)) {
    msg.data[0] = 0x00;
