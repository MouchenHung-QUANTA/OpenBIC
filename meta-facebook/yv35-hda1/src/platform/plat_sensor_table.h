...
#define SENSOR_NUM_VOL_PCP_VR 0x26 //AMP Mpro spec #73 VRD0
#define SENSOR_NUM_VOL_SOC_VR 0x27 //AMP Mpro spec #78 VRD1
#define SENSOR_NUM_VOL_VDDQ_DDR0123_VR 0x28 //AMP Mpro spec #83 VRD2
#define SENSOR_NUM_VOL_VDDQ_DDR4567_VR 0x29 //AMP Mpro #88 VRD3
#define SENSOR_NUM_VOL_D2D_VR 0x2A //AMP Mpro #93 VRD4
#define SENSOR_NUM_VOL_RC_DDR0_VR 0x2B //AMP Mpro #98 VRD5
#define SENSOR_NUM_VOL_RC_DDR1_VR 0x2C //AMP Mpro #103 VRD6
#define SENSOR_NUM_VOL_PCI_D_VR 0x2D //AMP Mpro #108 VRD7
#define SENSOR_NUM_VOL_PCI_A_VR 0x2E //AMP Mpro #113 VRD8

/* SENSOR NUMBER(1 based) - current */
#define SENSOR_NUM_CUR_HSCOUT 0x2F
#define SENSOR_NUM_CUR_PCP_VR 0x30 //AMP Mpro spec #74 VRD0
#define SENSOR_NUM_CUR_SOC_VR 0x31 //AMP Mpro spec #79 VRD1
#define SENSOR_NUM_CUR_VDDQ_DDR0123_VR 0x32 //AMP Mpro spec #84 VRD2
#define SENSOR_NUM_CUR_VDDQ_DDR4567_VR 0x33 //AMP Mpro #89 VRD3
#define SENSOR_NUM_CUR_D2D_VR 0x34 //AMP Mpro #94 VRD4
#define SENSOR_NUM_CUR_RC_DDR0_VR 0x35 //AMP Mpro #99 VRD5
#define SENSOR_NUM_CUR_RC_DDR1_VR 0x36 //AMP Mpro #104 VRD6
#define SENSOR_NUM_CUR_PCI_D_VR 0x37 //AMP Mpro #109 VRD7
#define SENSOR_NUM_CUR_PCI_A_VR 0x38 //AMP Mpro #114 VRD8

/* SENSOR NUMBER(1 based) - power */
#define SENSOR_NUM_PWR_CPU 0x39
#define SENSOR_NUM_PWR_HSCIN 0x3A

#define SENSOR_NUM_PWR_PCP_VR 0x3B //AMP Mpro spec #72 VRD0
#define SENSOR_NUM_PWR_SOC_VR 0x3C //AMP Mpro spec #77 VRD1
#define SENSOR_NUM_PWR_VDDQ_DDR0123_VR 0x3D //AMP Mpro spec #82 VRD2
#define SENSOR_NUM_PWR_VDDQ_DDR4567_VR 0x3E //AMP Mpro #87 VRD3
#define SENSOR_NUM_PWR_D2D_VR 0x3F //AMP Mpro #92 VRD4
#define SENSOR_NUM_PWR_RC_DDR0_VR 0x40 //AMP Mpro #97 VRD5
#define SENSOR_NUM_PWR_RC_DDR1_VR 0x41 //AMP Mpro #102 VRD6
#define SENSOR_NUM_PWR_PCI_D_VR 0x42 //AMP Mpro #107 VRD7
#define SENSOR_NUM_PWR_PCI_A_VR 0x43 //AMP Mpro #112 VRD8
