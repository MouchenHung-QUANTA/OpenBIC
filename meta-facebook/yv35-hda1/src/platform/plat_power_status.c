...
{
	k_thread_create(&bic_hb_thread, bic_hb_thread_stack, K_THREAD_STACK_SIZEOF(bic_hb_thread_stack),
			bic_hb_handler, NULL, NULL, NULL, CONFIG_MAIN_THREAD_PRIORITY, 0, K_NO_WAIT);
