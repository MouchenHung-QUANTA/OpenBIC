...
struct plat_mpro_sensor_mapping mpro_sensor_map[] = {
    {SENSOR_NUM_TEMP_PCP_VR, MPRO_SENSOR_NUM_TMP_VRD0},
	{SENSOR_NUM_TEMP_SOC_VR, MPRO_SENSOR_NUM_TMP_VRD1},
	{SENSOR_NUM_TEMP_VDDQ_DDR0123_VR, MPRO_SENSOR_NUM_TMP_VRD2},
	{SENSOR_NUM_TEMP_VDDQ_DDR4567_VR, MPRO_SENSOR_NUM_TMP_VRD3},
	{SENSOR_NUM_TEMP_D2D_VR, MPRO_SENSOR_NUM_TMP_VRD4},
	{SENSOR_NUM_TEMP_RC_DDR0_VR, MPRO_SENSOR_NUM_TMP_VRD5},
	{SENSOR_NUM_TEMP_RC_DDR1_VR, MPRO_SENSOR_NUM_TMP_VRD6},
	{SENSOR_NUM_TEMP_PCI_D_VR, MPRO_SENSOR_NUM_TMP_VRD7},
	{SENSOR_NUM_TEMP_PCI_A_VR, MPRO_SENSOR_NUM_TMP_VRD8},

	{SENSOR_NUM_PWR_PCP_VR, MPRO_SENSOR_NUM_PWR_VRD0},
	{SENSOR_NUM_PWR_SOC_VR, MPRO_SENSOR_NUM_PWR_VRD1},
	{SENSOR_NUM_PWR_VDDQ_DDR0123_VR, MPRO_SENSOR_NUM_PWR_VRD2},
	{SENSOR_NUM_PWR_VDDQ_DDR4567_VR, MPRO_SENSOR_NUM_PWR_VRD3},
	{SENSOR_NUM_PWR_D2D_VR, MPRO_SENSOR_NUM_PWR_VRD4},
	{SENSOR_NUM_PWR_RC_DDR0_VR, MPRO_SENSOR_NUM_PWR_VRD5},
	{SENSOR_NUM_PWR_RC_DDR1_VR, MPRO_SENSOR_NUM_PWR_VRD6},
	{SENSOR_NUM_PWR_PCI_D_VR, MPRO_SENSOR_NUM_PWR_VRD7},
	{SENSOR_NUM_PWR_PCI_A_VR, MPRO_SENSOR_NUM_PWR_VRD8},

	{SENSOR_NUM_VOL_PCP_VR, MPRO_SENSOR_NUM_VOL_VRD0},
	{SENSOR_NUM_VOL_SOC_VR, MPRO_SENSOR_NUM_VOL_VRD1},
	{SENSOR_NUM_VOL_VDDQ_DDR0123_VR, MPRO_SENSOR_NUM_VOL_VRD2},
	{SENSOR_NUM_VOL_VDDQ_DDR4567_VR, MPRO_SENSOR_NUM_VOL_VRD3},
	{SENSOR_NUM_VOL_D2D_VR, MPRO_SENSOR_NUM_VOL_VRD4},
	{SENSOR_NUM_VOL_RC_DDR0_VR, MPRO_SENSOR_NUM_VOL_VRD5},
	{SENSOR_NUM_VOL_RC_DDR1_VR, MPRO_SENSOR_NUM_VOL_VRD6},
	{SENSOR_NUM_VOL_PCI_D_VR, MPRO_SENSOR_NUM_VOL_VRD7},
	{SENSOR_NUM_VOL_PCI_A_VR, MPRO_SENSOR_NUM_VOL_VRD8},

	{SENSOR_NUM_CUR_PCP_VR, MPRO_SENSOR_NUM_CUR_VRD0},
	{SENSOR_NUM_CUR_SOC_VR, MPRO_SENSOR_NUM_CUR_VRD1},
	{SENSOR_NUM_CUR_VDDQ_DDR0123_VR, MPRO_SENSOR_NUM_CUR_VRD2},
	{SENSOR_NUM_CUR_VDDQ_DDR4567_VR, MPRO_SENSOR_NUM_CUR_VRD3},
	{SENSOR_NUM_CUR_D2D_VR, MPRO_SENSOR_NUM_CUR_VRD4},
	{SENSOR_NUM_CUR_RC_DDR0_VR, MPRO_SENSOR_NUM_CUR_VRD5},
	{SENSOR_NUM_CUR_RC_DDR1_VR, MPRO_SENSOR_NUM_CUR_VRD6},
	{SENSOR_NUM_CUR_PCI_D_VR, MPRO_SENSOR_NUM_CUR_VRD7},
	{SENSOR_NUM_CUR_PCI_A_VR, MPRO_SENSOR_NUM_CUR_VRD8},
};
