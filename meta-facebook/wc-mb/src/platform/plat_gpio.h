...
#define name_gpioF                                                                                 \
	gpio_name_to_num(LED_POSTCODE_0) gpio_name_to_num(LED_POSTCODE_1)                          \
		gpio_name_to_num(LED_POSTCODE_2) gpio_name_to_num(LED_POSTCODE_3)                  \
			gpio_name_to_num(LED_POSTCODE_4) gpio_name_to_num(LED_POSTCODE_5)          \
				gpio_name_to_num(LED_POSTCODE_6) gpio_name_to_num(LED_POSTCODE_7)
#define name_gpioG                                                                                 \
	...
	gpio_name_to_num(Reserve_GPIOL0) gpio_name_to_num(Reserve_GPIOL1)                          \
		gpio_name_to_num(Reserve_GPIOL2) gpio_name_to_num(Reserve_GPIOL3)                  \
			gpio_name_to_num(IRQ_PVCCD_CPU0_VRHOT_LVC3_N)                              \
				gpio_name_to_num(IRQ_PSYS_CRIT_N) gpio_name_to_num(SYS_SKU_ID1)    \
