...
sensor_cfg plat_sensor_config[] = {
	...
	{ SENSOR_NUM_VOL_ADC11_FBVDDQ, sensor_dev_ast_adc, ADC_PORT11, NONE, NONE, dc_access, 1,
	  1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, NULL, NULL, &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_ADC12_FBVDDP2, sensor_dev_ast_adc, ADC_PORT12, NONE, NONE, dc_access, 1,
	  1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, NULL, NULL, &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_ADC13_FBVDD1, sensor_dev_ast_adc, ADC_PORT13, NONE, NONE, dc_access, 1,
	  1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, NULL, NULL, &ast_adc_init_args[0] },
...
sensor_cfg pt4080l_sensor_config_table[] = {
	{ SENSOR_NUM_TEMP_RETIMER, sensor_dev_pt5161l, I2C_BUS2, AL_RETIMER_ADDR,
	  ...
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_retimer_read, NULL,
...
sensor_cfg ds160pt801_sensor_config_table[] = {
	{ SENSOR_NUM_TEMP_RETIMER, sensor_dev_ds160pt801, I2C_BUS2, TI_RETIMER_ADDR,
	  ...
	  DISABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL,
	  NULL, NULL, NULL },
};
