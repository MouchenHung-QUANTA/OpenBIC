...
sensor_cfg plat_sensor_config[] = {
	...
	{ SENSOR_NUM_VOL_ADC7_1V2, sensor_dev_ast_adc, ADC_PORT7, NONE, NONE, dc_access, 1, 1,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	  NULL, NULL, NULL, NULL, &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_ADC9_VDD_3V3, sensor_dev_ast_adc, ADC_PORT9, NONE, NONE, dc_access, 2, 1,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS,
	...
	{ SENSOR_NUM_PWR_E1S, sensor_dev_ina230, I2C_BUS2, INA230_ADDR, INA230_PWR_OFFSET,
	  e1s_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, DISABLE_SENSOR_POLLING, 0,
	...
	{ SENSOR_NUM_TEMP_CPU, sensor_dev_nv_satmc, MCTP_I2C_SATMC_BUS, (MCTP_I2C_SATMC_ADDR >> 1),
	  NONE, satmc_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING,
	  0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &satmc_init_args[0] },
	{ SENSOR_NUM_VOL_CPUVDD, sensor_dev_nv_satmc, MCTP_I2C_SATMC_BUS,
	  (MCTP_I2C_SATMC_ADDR >> 1), NONE, satmc_access, 0, 0, SAMPLE_COUNT_DEFAULT,
	...
	{ SENSOR_NUM_OTH_PAGE_RETIRE_CNT, sensor_dev_nv_satmc, MCTP_I2C_SATMC_BUS,
	  (MCTP_I2C_SATMC_ADDR >> 1), NONE, satmc_access, 0, 0, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &satmc_init_args[6] },
...
sensor_cfg mp5990_sensor_config_table[] = {
	...
	{ SENSOR_NUM_PWR_HSCIN, sensor_dev_mp5990, I2C_BUS2, MP5990_ADDR, PMBUS_READ_EIN,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, DISABLE_SENSOR_POLLING, 0,
...
sensor_cfg rs31380r_temp_sensor_config_table[] = {
	{ SENSOR_NUM_TEMP_HSC, sensor_dev_rs31380r, I2C_BUS2, RS31380R_ADDR,
	  ...
	  DISABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
...
sensor_cfg pt4080l_sensor_config_table[] = {
	{ SENSOR_NUM_TEMP_RETIMER, sensor_dev_pt5161l, I2C_BUS2, AL_RETIMER_ADDR,
	  ...
	  DISABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_pt4080l_read, &mux_conf_addr_0xe2[1],
...
sensor_cfg ds160pt801_sensor_config_table[] = {
	{ SENSOR_NUM_TEMP_RETIMER, sensor_dev_ds160pt801, I2C_BUS2, TI_RETIMER_ADDR,
	  ...
	  DISABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, pre_ds160pt801_read, &mux_conf_addr_0xe2[1],
	  NULL, NULL, NULL },
};
