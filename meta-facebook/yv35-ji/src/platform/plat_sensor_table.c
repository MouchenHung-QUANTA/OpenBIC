...
sensor_cfg plat_sensor_config[] = {
	...
	{ SENSOR_NUM_VOL_CPUDVDD, sensor_dev_mpq8746, I2C_BUS3, MPQ8746_ADDR, PMBUS_READ_VOUT,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, pre_vr_read, NULL, post_vr_read, NULL, NULL },
	{ SENSOR_NUM_CUR_CPUDVDD, sensor_dev_mpq8746, I2C_BUS3, MPQ8746_ADDR, PMBUS_READ_IOUT,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, pre_vr_read, NULL, post_vr_read, NULL, NULL },
	{ SENSOR_NUM_PWR_CPUDVDD, sensor_dev_mpq8746, I2C_BUS3, MPQ8746_ADDR, PMBUS_READ_POUT,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, pre_vr_read, NULL, post_vr_read, NULL, NULL },
	{ SENSOR_NUM_TEMP_CPUDVDD, sensor_dev_mpq8746, I2C_BUS3, MPQ8746_ADDR, PMBUS_READ_TEMPERATURE_1,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, pre_vr_read, NULL, post_vr_read, NULL, NULL },

	{ SENSOR_NUM_VOL_CPUVDD, sensor_dev_mp289x, I2C_BUS3, MP2898_ADDR, PMBUS_READ_VOUT,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, pre_vr_read, NULL, post_vr_read, NULL, NULL },
	{ SENSOR_NUM_CUR_CPUVDD, sensor_dev_mp289x, I2C_BUS3, MP2898_ADDR, PMBUS_READ_IOUT,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, pre_vr_read, NULL, post_vr_read, NULL, NULL },
	{ SENSOR_NUM_PWR_CPUVDD, sensor_dev_mp289x, I2C_BUS3, MP2898_ADDR, PMBUS_READ_POUT,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, pre_vr_read, NULL, post_vr_read, NULL, NULL },
	{ SENSOR_NUM_TEMP_CPUVDD, sensor_dev_mp289x, I2C_BUS3, MP2898_ADDR, PMBUS_READ_TEMPERATURE_1,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, pre_vr_read, NULL, post_vr_read, NULL, NULL },

	{ SENSOR_NUM_VOL_SOCVDD, sensor_dev_mp289x, I2C_BUS3, MP2894_ADDR, PMBUS_READ_VOUT,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, pre_vr_read, NULL, post_vr_read, NULL, NULL },
	{ SENSOR_NUM_CUR_SOCVDD, sensor_dev_mp289x, I2C_BUS3, MP2894_ADDR, PMBUS_READ_IOUT,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, pre_vr_read, NULL, post_vr_read, NULL, NULL },
	{ SENSOR_NUM_PWR_SOCVDD, sensor_dev_mp289x, I2C_BUS3, MP2894_ADDR, PMBUS_READ_POUT,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, pre_vr_read, NULL, post_vr_read, NULL, NULL },
	{ SENSOR_NUM_TEMP_SOCVDD, sensor_dev_mp289x, I2C_BUS3, MP2894_ADDR, PMBUS_READ_TEMPERATURE_1,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, pre_vr_read, NULL, post_vr_read, NULL, NULL },
#endif
