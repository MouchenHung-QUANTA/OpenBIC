...
sensor_cfg plat_sensor_config[] = {
	...
	/* NVME */
	{ SENSOR_NUM_TEMP_E1S_SSD, sensor_dev_nvme, I2C_BUS10, E1S_SSD_ADDR, SSD_TEMP_OFFSET, post_access, 0,
	...
	{ SENSOR_NUM_VOL_ADC1_VDD_1V8, sensor_dev_ast_adc, ADC_PORT1, NONE, NONE, stby_access, 1,
	...
	{ SENSOR_NUM_VOL_ADC10_P1V2_STBY, sensor_dev_ast_adc, ADC_PORT10, NONE, NONE, stby_access,
	  1, 1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_ADC11_FBVDDQ, sensor_dev_ast_adc, ADC_PORT11, NONE, NONE, stby_access,
	  1, 1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_ADC12_FBVDDP2, sensor_dev_ast_adc, ADC_PORT12, NONE, NONE, stby_access,
	  1, 1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &ast_adc_init_args[0] },
	{ SENSOR_NUM_VOL_ADC13_FBVDD1, sensor_dev_ast_adc, ADC_PORT13, NONE, NONE, stby_access,
	  1, 1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &ast_adc_init_args[0] },
...
#ifdef ENABLE_NVIDIA
	/* SatMC */
	{ SENSOR_NUM_TEMP_CPU, sensor_dev_nv_satmc, MCTP_I2C_SATMC_BUS, (MCTP_I2C_SATMC_ADDR >> 1), NONE,
	...
	{ SENSOR_NUM_VOL_CPUVDD, sensor_dev_nv_satmc, MCTP_I2C_SATMC_BUS, (MCTP_I2C_SATMC_ADDR >> 1), NONE,
	  post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &satmc_init_args[2] },
	{ SENSOR_NUM_VOL_SOCVDD, sensor_dev_nv_satmc, MCTP_I2C_SATMC_BUS, (MCTP_I2C_SATMC_ADDR >> 1), NONE,
	  post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &satmc_init_args[4] },
	{ SENSOR_NUM_PWR_CPUVDD, sensor_dev_nv_satmc, MCTP_I2C_SATMC_BUS, (MCTP_I2C_SATMC_ADDR >> 1), NONE,
	  post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &satmc_init_args[1] },
	{ SENSOR_NUM_PWR_SOCVDD, sensor_dev_nv_satmc, MCTP_I2C_SATMC_BUS, (MCTP_I2C_SATMC_ADDR >> 1), NONE,
	  post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &satmc_init_args[3] },
	{ SENSOR_NUM_PWR_CPU, sensor_dev_nv_satmc, MCTP_I2C_SATMC_BUS, (MCTP_I2C_SATMC_ADDR >> 1), NONE,
	  post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &satmc_init_args[5] },
	{ SENSOR_NUM_OTH_CPU_THROTTLE, sensor_dev_nv_satmc, MCTP_I2C_SATMC_BUS, (MCTP_I2C_SATMC_ADDR >> 1), NONE,
	  post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &satmc_init_args[6] },
	{ SENSOR_NUM_OTH_POWER_BREAK, sensor_dev_nv_satmc, MCTP_I2C_SATMC_BUS, (MCTP_I2C_SATMC_ADDR >> 1), NONE,
	  post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &satmc_init_args[7] },
	{ SENSOR_NUM_OTH_SPARE_CHANNEL, sensor_dev_nv_satmc, MCTP_I2C_SATMC_BUS, (MCTP_I2C_SATMC_ADDR >> 1), NONE,
	  post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &satmc_init_args[8] },
#endif
};
